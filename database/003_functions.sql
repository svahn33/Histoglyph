...
-- Accept exact answers or a shortened first-name + surname answer.
-- Each supplied name part must contain at least three letters, e.g. "Ado Hit" for "Adolf Hitler".
...
begin
  ...
  -- Ignore common generational suffixes when finding the candidate surname.
